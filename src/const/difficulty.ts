...
export const DIFFICULTY = {
  ...
  BUILDING_LIMITED_BOUND: 99, // Max bound for limited buildngs
...
export const DIFFICULTY_RESOURCES = {
  EASY: {
    PLAYER_START_SILVER: 2000,
    PLAYER_START_LUMBER: 4000,
